...
class WordIndexer(object):
    ...
    def add_and_get_index(self, object, add=True):
        ...
        if object not in self.objs_to_ints:
            ...
            self.objs_to_ints[object] = new_idx # dict word:num
            self.ints_to_objs[new_idx] = object # dict num:word
        return self.objs_to_ints[object]


def load_vocabulary(embeddings_file: str) -> WordEmbeddings: # 加载词向量
